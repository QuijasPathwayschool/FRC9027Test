...
public class ArmSubsystem extends SubsystemBase {
  ...
  public ArmSubsystem() {
    ...
    m_motor2 = new CANSparkMax(Constants.Arm.kArmRightCanId, CANSparkMaxLowLevel.MotorType.kBrushless);
    ...
    m_motor2.setSoftLimit(SoftLimitDirection.kForward, (float)Constants.Arm.kSoftLimitForward);
    m_motor2.setSoftLimit(SoftLimitDirection.kReverse, (float)Constants.Arm.kSoftLimitReverse);
