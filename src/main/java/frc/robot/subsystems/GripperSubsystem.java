...
public class GripperSubsystem extends SubsystemBase {
  ...
  public GripperSubsystem() {
    ...
    m_motor2 = new CANSparkMax(Constants.Gripper.kGripperRightCanId, CANSparkMaxLowLevel.MotorType.kBrushless);
    ...
    m_motor2.setSmartCurrentLimit(Constants.Gripper.kCurrentLimit);
    m_motor2.enableSoftLimit(SoftLimitDirection.kForward, true);
    m_motor2.enableSoftLimit(SoftLimitDirection.kReverse, true);
    m_motor2.setSoftLimit(SoftLimitDirection.kForward, (float)Constants.Gripper.kSoftLimitForward);
    m_motor2.setSoftLimit(SoftLimitDirection.kReverse, (float)Constants.Gripper.kSoftLimitReverse);
